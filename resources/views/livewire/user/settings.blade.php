<div class="content">
    <section class="w-full p-5 space-y-3 content">
        ...
        <form wire:submit.prevent='toggleTwoFactorAuthentication'>
            @csrf
            {{-- TODO : I need to refactor this code to give to user the right to change stats of 2fact --}}
            <div class="w-full p-5 space-y-2 bg-white border rounded-lg">
                ...
                <div class="inline-flex items-center justify-start w-full gap-5">
                    <div class="p-5 border-2 rounded-lg border-black/40">
                        {!! auth()->user()->twoFactorQrCodeSvg() !!}
                    </div>
                    <div class="space-y-3">
                        <h1> Recovery codes are used to access in the event you cannot access your two-factor
                            Authentication codes.</h1>
                        <div class="relative w-full py-5 border-2 rounded-lg bg-black/5 border-black/40 " x-data="{
                                    copyText: '',
                            ...
                            <ul class="grid content-center grid-cols-2 grid-rows-4 gap-4 justify-items-center ">
