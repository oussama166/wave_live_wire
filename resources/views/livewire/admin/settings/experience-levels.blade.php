<div class="content">
    <section
                        ...
                        <div class="w-full relative">
                            ...
                            >
                                <div class="w-6 h-6 text-primary-500"
                                     ...
                                     @click="$dispatch('changeData',{id:'{{$exp['id']}}'})"
                                >
                                    <x-eos-mode-edit-o />
                                </div>
                                <hr class="w-6 h-0.5 bg-primary500/40 rotate-90"/>
                                <div class="w-6 h-6 text-primary-500"
                                     @click="$dispatch('deleteData',{id:'{{$exp['id']}}'})"
                                >
        ...
        <aside class="w-max-[50%] w-full space-y-5">
            ...
            <div>
                <h1 class="text-2xl text-primary-500 uppercase">New Experience levels or Modified the existing one</h1>
            </div>
