        ...
        @forelse ($data as $value)
            @if($type == 'static')
                <tr class="font-semibold text-primary-700 hover:bg-primary-300/10 ">
                    <td class="px-5 py-4 space-y-1 text-sm font-semibold whitespace-nowrap cursor-pointer">
            ...
            @elseif($type == 'dynamic')
                <tr @click="window.location.href='/admin/vacationRequest/edit/{{$value->id}}'"
                    class="font-semibold text-primary-700 hover:bg-primary-300/10 cursor-pointer">
